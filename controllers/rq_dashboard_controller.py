...
@rq_dashboard_blueprint.before_app_first_request
...
@rq_dashboard_blueprint.before_request
def push_rq_connection():
    push_connection(current_app.redis_conn)


@rq_dashboard_blueprint.teardown_request
...
@rq_dashboard_blueprint.route('/', defaults={'queue_name': None, 'page': '1'})
@rq_dashboard_blueprint.route('/<queue_name>', defaults={'page': '1'})
@rq_dashboard_blueprint.route('/<queue_name>/<page>')
...
@rq_dashboard_blueprint.route('/job/<job_id>/cancel', methods=['POST'])
@jsonify
...
@rq_dashboard_blueprint.route('/job/<job_id>/requeue', methods=['POST'])
@jsonify
...
@rq_dashboard_blueprint.route('/requeue-all', methods=['GET', 'POST'])
@jsonify
def requeue_all():
    fq = get_failed_queue()
    job_ids = fq.job_ids
...
@rq_dashboard_blueprint.route('/queue/<queue_name>/empty', methods=['POST'])
@jsonify
...
@rq_dashboard_blueprint.route('/queue/<queue_name>/compact', methods=['POST'])
@jsonify
...
@rq_dashboard_blueprint.route('/queues.json')
@jsonify
def list_queues():
...
@rq_dashboard_blueprint.route('/jobs/<queue_name>/<page>.json')
@jsonify
...
@rq_dashboard_blueprint.route('/workers.json')
@jsonify
def list_workers():
...
@rq_dashboard_blueprint.context_processor
def inject_interval():
